...
public class SniperHitAbility extends ItemAbility<InteractAbility> {
    ...
    public void trigger(InteractAbility data) {
        ...
        HitscanProjectile hitscanProjectile = new HitscanProjectile(0.001, 50, null, entity -> {
            if(entity instanceof Damageable damageable) damageable.damage(50);
        });
        hitscanProjectile.shoot(data.getEvent().getPlayer(), 120);
        hitscanProjectile.highlight("CRIT,1", 0.01, 0);
