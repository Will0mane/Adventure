...
public class MongoProtection extends AmountStatistic<Double> {

    private static final String DB_KEY = "protection";
    ...
    public MongoProtection(AdventureMongoDB  mongoDB){
