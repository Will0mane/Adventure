...
public enum PetType {
    ...
    //COMMON
    TIGER("Tiger", PetRarity.COMMON, Particle.CRIT,
            Arrays.asList(
                    "&7A combat pet:",
    ...
    //EPIC
    ENDERMAN_EVOKER("Enderman Evoker", PetRarity.EPIC, Particle.END_ROD,
            Arrays.asList(
                    "&7A movement pet:",
                    "&7Walk to gain &bXP"
            ),
    ...
    PetType(String name, PetRarity rarity, Particle particle, List<String> lore, List<BiConsumer<AdventurePet, GenericEvent>> consumers, String headValue) {
        this.name = name;
        this.rarity = rarity;
